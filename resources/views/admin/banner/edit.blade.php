...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-banner')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <input type="text" class="form-control" name="banner_heading" value="{{$banner->banner_heading}}" />
                                </div>

                                <div class="col-lg-12 col-md-12 mtb-10">
                                    <label class="control-label" for="password"> Banner sub heading </label>
                                    <input type="text" class="form-control" name="banner_subheading" value="{{$banner->banner_subheading}}" />
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        ...
                                        <img src="{{asset('/'.$banner->banner)}}" style="width:100px;">
                                    </div>
                                </div>
