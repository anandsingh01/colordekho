...
@section('body')
    ...
    <div class="row clearfix">
        <div class="col-lg-5 col-md-5 col-sm-12">
            <div class="card">
                <div class="body">
                    <form method="post" action="{{url('admin/update-bikes-color')}}" class="category_form"
                        ...
                        <div class="form-group">
                            ...
                            <select name="bike_id" class="form-control ms select2">
                                @forelse($bike_manufacturer as $bike_manufacturers)
                                    <option value="{{$bike_manufacturers->id}}" {{$color->color == $bike_manufacturers->id ? 'selected' : ''}}>{{$bike_manufacturers->name}}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
