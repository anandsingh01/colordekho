...
@section('body')
    ...
    <div class="row clearfix">
        <div class="col-lg-5 col-md-5 col-sm-12">
            <div class="card">
                <div class="body">
                    <form method="post" action="{{url('admin/update-bikes-variations')}}" class="category_form"
                        ...
                        <div class="form-group">
                            ...
                            <select name="color_id" class="form-control ms select2">
                                @forelse($bike_colors as $all_colors)
                        ...
                        <div class="form-group">
                            ...
                            <input name="mrp" value="{{$variations->mrp}}"  type="number" id="mrp_price" class="form-control" placeholder="">
                        </div>
